...
/**
 * @brief permet d'écrire un mot dans une liste sans vérifier s'il s'agit d'un doublon. Et permet aussi d'allouer de l'espace pour des nouvelles listes dynamiquement
 * @param id : mot entré
 * @param liste : liste de mot
*/
